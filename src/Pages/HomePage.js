        ...
        <div className="mx-auto max-w-[800px] px-4 pb-1 pt-6 text-lg sm:px-12 md:px-16">
          ...
          <div>
            ...
            >
              ...
              <p className="my-3 flex flex-wrap gap-2 sm:gap-6 sm:flex sm:space-x-4 ">
                <a className="hidden sm:flex flex items-center gap-2 font-normal transition-colors hover:text-zinc-200 sm:bg-transparent bg-zinc-800 rounded-lg py-1.5 sm:py-0 sm:px-0 px-3"
