...
const AnimeCard = ({ anime }) => {
  ...
  return (
    <Link to={`/anime/${anime.id}`} className="block transition-transform hover:scale-[1.01]">
      <div className="bg-white rounded-xl shadow-sm hover:shadow-md border border-gray-100 overflow-hidden transition-all duration-200">
        <div className="flex">
          <div className="w-24 md:w-32 aspect-[4/5] flex-shrink-0 relative bg-gray-100 overflow-hidden">
            <img
              src={anime.thumbnail}
              alt={anime.title}
