...
=======
                                <Link to="/certificate" className="block px-4 py-2 text-sm text-gray-300 hover:bg-zinc-700">Certificate</Link>
                                <Link to="/islamic" className="block px-4 py-2 text-sm text-gray-300 hover:bg-zinc-700">Islamic</Link>
                                <Link to="/blog" className="block px-4 py-2 text-sm text-gray-300 hover:bg-zinc-700">Blog</Link>
>>>>>>> 72b2c3a (update)
                            </div>
                        )}
                    </div>
