...
const pricelist = [
    {
        category: "Sharing",
        options: [
            { duration: "1 hari", price: "6.000" },
            { duration: "3 hari", price: "7.500" },
    ...
    return (
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-[110px]">
        ...
        <div className="text-center flex-col sm:flex-row justify-between items-start sm:items-center mb-3 sm:mb-8 gap-4">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 pt-10">Capcut Pricelist</h1>
