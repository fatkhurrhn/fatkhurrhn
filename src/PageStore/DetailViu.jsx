...
const pricelist = [
    ...
    },
    {
        ...
        options: [
            ...
            { duration: "2 bulan", price: "8.5k" },
            { duration: "3 bulan", price: "10k" },
            { duration: "4 bulan", price: "12k" },
            { duration: "1 tahun", price: "19k" }
        ]
    },
    {
...
export default function Page() {
    ...
    const handleOrder = () => {
        ...
        const message = `Order Apk Viu Premium ${selected}\n\nApa ada stok kak?`;
    ...
    return (
        <div className="bg-[#141417] min-h-screen text-gray-900 dark:text-white transition-colors duration-300 relative">
            ...
            <section className="max-w-4xl mx-auto px-5 pt-20">
                <h1 className="text-2xl font-bold  text-center text-gray-300 mb-2">Viu</h1>
